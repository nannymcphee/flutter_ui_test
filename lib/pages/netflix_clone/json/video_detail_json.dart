...
const List<Map<Object, Object>> likesList = [
  {'icon': Icons.add, 'text': 'My List'},
  {'icon': Icons.thumb_up_alt_outlined, 'text': 'Rate'},
  {'icon': Icons.send_outlined, 'text': 'Share'}
];
const List<String> episodesList = ['EPISODES', 'TRAILERS & MORE', 'MORE LIKE THIS'];

const List<Map<Object, Object>> movieList = [
  {
    'img': 'assets/app/icons/detail_1.webp',
  ...
  {
    'img': 'assets/app/icons/detail_2.webp',
  ...
  {
    'img': 'assets/app/icons/detail_3.webp',
  ...
  {
    'img': 'assets/app/icons/detail_4.webp',
    'title': '4. Complete Control',
    'description':
        'Toyotomi Hideyoshi ascendes to power as the de factor ruler of Japan. Still, Date Masamune, a young daimyo in the north, ignores his missives.',
    'duration': '43m'
  },
  {
    'img': 'assets/app/icons/detail_5.webp',
    'title': '5. Catastrophe',
    'description':
  ...
  {
    'img': 'assets/app/icons/detail_6.webp',
